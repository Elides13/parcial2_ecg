...
import SerieCard from './SerieCard.vue'; // Importa el componente SerieCard
...
.serie-card {
  flex: 1 1 300px; /* Crecer, encoger, tamaño base */
  max-width: 300px; /* Asegurarse de que no crezcan demasiado */
}
</style>
